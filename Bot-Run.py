...
def baner():
    print (''' 
  \033[32;1m╔════════════════════════════════════════════════╗
               \033[33;1m✔DevLOPER : FAIZUL BOFTEN
               \033[33;1m✔FACEBOOK0: FAIZUL
               \033[33;1m✔WHATSAPP : 082271426251
  \033[32;1m╚════════════════════════════════════════════════╝
  
\033[32;1m▒╔╗╔╗╔╦╗        \033[34;1mSPAMMER   : V4
\033[32;1m▒╠╣║║╠╣╠╦═╗     \033[34;1mDEV      : FAIZUL
\033[32;1m▒║║║╚╣║═╣╩╣     \033[34;1mWHATSAPP : 082271426251
\033[32;1m▒╚╝╚═╩╩╩╩═╝''')  
def kata(s):
    for c in s + "\n":
        sys.stdout.write(c)
...
if __name__=="__main__":
     try:
          ...
          kata("\033[31;1mNOTE : GUNAKAN SCRIP SEBAIK BAIKNYA ")
          kata("\033[31;1mADMIN TIDAK BERANGGUNG JAWAB ATAS APA YANG TERJADI")
          kata("\033[31;1mKALO MAU RECODE IZIN DULU BIAR WORK/CANTUMKAN NAMA AUTHOR NYA")
          kata("===================================================")
          jenius()
          ...
          kata("[+]\033[32;1mTERIMAKASIH SUDAH MENGUNAKAN SCRIP INI..")
          balik()
     except KeyError:
             sys.exit()
